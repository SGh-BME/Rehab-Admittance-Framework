...
class SimulationController:
    ...
    def _create_target_marker(self):
        """Create a small sphere above EE z for target visualization (visual only, no collision)."""
        self.target_marker_radius = 0.015  # 1.5 cm sphere
        self.target_marker_z_offset = 0.06  # place 8 cm above EE so it clears the geometry
    ...
    def _update_target_marker(self):
        """Move target marker to (target_x, target_y, fixed_z + offset) or hide if no target."""
